...
public:
	...
	// Callback that is called during event loop periodically
	void add_periodic_callback(int period_sec, std::function<void()> &&callback);
...
private:
	...
	void process_periodic_callback();
